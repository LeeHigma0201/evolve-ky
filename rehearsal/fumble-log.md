# FUMBLE LOG — what to drill

Running record across rehearsal passes. Add a row every time something comes out wrong, slow, or apologetic. **Anything that shows up twice gets drilled until it's automatic.**

---

## A/B picks (fill in as we run them)
...
## Coaching misses (mine — track so the drills get better)
